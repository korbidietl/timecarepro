...
def mitarbeiter():
    ...
    if not mitarbeiterliste:
        ...
        return render_template('FAN030_show_employee_table.html', error_message=error_message)

    return render_template('FAN030_show_employee_table.html', mitarbeitern=mitarbeitern)
